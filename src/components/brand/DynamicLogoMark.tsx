  ...
  if (isYellowImoveis) {
    const logoElement = (
      <HousePinLogo 
        ...
        style={{ opacity: (goldenOverlay !== undefined && goldenOverlay !== "none") ? 0.22 : 1 }} 
      />
    );
    if (goldenOverlay !== undefined) {
      return (
        <div 
          ...
          {goldenOverlay !== "none" && (
            <svg viewBox="0 0 380 360" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 w-full h-full z-20 pointer-events-none animate-fade-in">
              ...
              {goldenOverlay === "circles" && (
                <g>
                  <circle cx="190" cy="180" r="170" stroke="var(--primary, currentColor)" strokeWidth="1.5" strokeDasharray="3 3" fill="none" opacity="0.8" />
                  <circle cx="190" cy="180" r="105" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="3 3" fill="none" opacity="0.8" />
                  <circle cx="190" cy="180" r="65" stroke="#E8A14B" strokeWidth="1.2" strokeDasharray="2 2" fill="none" opacity="0.9" />
                </g>
              )}
              {goldenOverlay === "grid" && (
                <g>
                  <line x1="190" y1="0" x2="190" y2="360" stroke="var(--primary, currentColor)" strokeWidth="1" strokeDasharray="2 2" opacity="0.9" />
                  <line x1="0" y1="180" x2="380" y2="180" stroke="var(--primary, currentColor)" strokeWidth="1" strokeDasharray="2 2" opacity="0.9" />
                  <rect x="20" y="10" width="340" height="340" stroke="var(--primary, currentColor)" strokeWidth="1" fill="none" opacity="0.75" />
                  <circle cx="190" cy="180" r="170" stroke="var(--primary, currentColor)" strokeWidth="1" fill="none" opacity="0.75" />
                  <line x1="20" y1="10" x2="360" y2="350" stroke="var(--primary, currentColor)" strokeWidth="1" opacity="0.65" />
                  <line x1="360" y1="10" x2="20" y2="350" stroke="var(--primary, currentColor)" strokeWidth="1" opacity="0.65" />
                </g>
              )}
            </svg>
          )}
        ...
        {goldenOverlay !== "none" && (
          <svg viewBox="0 0 380 360" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 w-full h-full z-20 pointer-events-none animate-fade-in">
            ...
            {goldenOverlay === "circles" && (
              isAlbert ? (
                <g>
                  <circle cx="85.6" cy="162.7" r="82.1" stroke="var(--primary, currentColor)" strokeWidth="1.5" strokeDasharray="3 3" fill="none" opacity="0.8" />
                  <circle cx="85.6" cy="162.7" r="73.7" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="3 3" fill="none" opacity="0.8" />
                  <circle cx="85.6" cy="162.7" r="50.7" stroke="#E8A14B" strokeWidth="1.2" strokeDasharray="2 2" fill="none" opacity="0.9" />
                  <circle cx="85.6" cy="162.7" r="31.3" stroke="#E8A14B" strokeWidth="1" strokeDasharray="2 2" fill="none" opacity="0.7" />

                  <circle cx="292.3" cy="162.7" r="82.1" stroke="var(--primary, currentColor)" strokeWidth="1.5" strokeDasharray="3 3" fill="none" opacity="0.8" />
                  <circle cx="292.3" cy="162.7" r="73.7" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="3 3" fill="none" opacity="0.8" />
                  <circle cx="292.3" cy="162.7" r="50.7" stroke="#E8A14B" strokeWidth="1.2" strokeDasharray="2 2" fill="none" opacity="0.9" />
                  <circle cx="292.3" cy="162.7" r="31.3" stroke="#E8A14B" strokeWidth="1" strokeDasharray="2 2" fill="none" opacity="0.7" />
                </g>
              ) : (
                <g>
                  <circle cx="190" cy="180" r="170" stroke="var(--primary, currentColor)" strokeWidth="1.5" strokeDasharray="3 3" fill="none" opacity="0.8" />
            ...
            {goldenOverlay === "grid" && (
              isAlbert ? (
                <g>
                  <line x1="85.6" y1="0" x2="85.6" y2="360" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="2 2" opacity="0.95" />
                  <line x1="292.3" y1="0" x2="292.3" y2="360" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="2 2" opacity="0.95" />
                  <line x1="189.3" y1="0" x2="189.3" y2="360" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="2 2" opacity="0.95" />
                  
                  <line x1="0" y1="162.7" x2="380" y2="162.7" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="2 2" opacity="0.95" />
                  <line x1="20" y1="80.6" x2="360" y2="80.6" stroke="var(--primary, currentColor)" strokeWidth="1" strokeDasharray="3 3" opacity="0.85" />
                  <line x1="20" y1="244.8" x2="360" y2="244.8" stroke="var(--primary, currentColor)" strokeWidth="1" strokeDasharray="3 3" opacity="0.85" />

                  <rect x="3.5" y="80.6" width="370.9" height="164.2" stroke="var(--primary, currentColor)" strokeWidth="1" fill="none" opacity="0.75" />
                  
                  <line x1="3.5" y1="80.6" x2="374.4" y2="244.8" stroke="var(--primary, currentColor)" strokeWidth="1" opacity="0.65" />
                  <line x1="374.4" y1="80.6" x2="3.5" y2="244.8" stroke="var(--primary, currentColor)" strokeWidth="1" opacity="0.65" />
                </g>
              ) : (
                <g>
                  <line x1="190" y1="0" x2="190" y2="360" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="2 2" opacity="0.9" />
                  <line x1="0" y1="180" x2="380" y2="180" stroke="var(--primary, currentColor)" strokeWidth="1.2" strokeDasharray="2 2" opacity="0.9" />
                  <rect x="20" y="10" width="340" height="340" stroke="var(--primary, currentColor)" strokeWidth="1" fill="none" opacity="0.75" />
                  <circle cx="190" cy="180" r="170" stroke="var(--primary, currentColor)" strokeWidth="1" fill="none" opacity="0.75" />
                  <line x1="20" y1="10" x2="360" y2="350" stroke="var(--primary, currentColor)" strokeWidth="1.2" opacity="0.65" />
                  <line x1="360" y1="10" x2="20" y2="350" stroke="var(--primary, currentColor)" strokeWidth="1.2" opacity="0.65" />
                </g>
              )
            )}
          </svg>
